# GOAL.md — Cold Email Reply Intent Classifier
...
Scrapes Gmail threads, classifies replies as intent, auto-reply, unsubscribe, or dead. Uses lightweight keyword/pattern matching. Quick MVP with rule-based logic.
