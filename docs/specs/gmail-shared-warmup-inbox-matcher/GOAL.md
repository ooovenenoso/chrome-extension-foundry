# GOAL.md — Gmail Shared Warmup Inbox Matcher
...
Matches users who want warmup partners and schedules automated open/reply simulations between each others emails. Solves a real pain for cold emailers and has clear network effects. Tip jar model work
