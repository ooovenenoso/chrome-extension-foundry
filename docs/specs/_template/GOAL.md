...
<ONE_SENTENCE: who is this for, what pain does it kill, how will they describe it to a friend?>
...
- **Content script** — runs on `<MATCH_PATTERN>` (e.g. `https://*.linkedin.com/*`)
