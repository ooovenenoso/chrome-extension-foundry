# GOAL.md — Cold Email Domain Blacklist Pre-Flight
...
When composing in Gmail/Outlook web, runs the From domain against DNSBL lists in the background and shows a warning chip before send. Why now: Gmail tightened bulk sender rules again in 2026, so domai
