# GOAL.md — Email Thread Priority Scorer
...
Scans Gmail inbox using LLM to score email priority based on sender importance, urgency signals, and deal context. Built in 2 weeks with Gmail API. Directly addresses inbox overload for sales teams. P
