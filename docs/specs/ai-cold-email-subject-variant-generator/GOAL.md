# GOAL.md — AI Cold Email Subject Variant Generator
...
Buildable in 2-3 weeks using OpenAI's API and a small prompt-engine prompt pack per persona. The wave of AI-powered sales tooling (Smartlead, Instantly) created a pipeline gap: nothing scores subject 
