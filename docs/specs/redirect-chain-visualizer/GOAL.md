# GOAL.md — Redirect Chain Visualizer
...
Fetches the full redirect chain on click and renders it as a vertical timeline with status codes, headers, and timing per hop. Flags 301/302 loops and suspicious redirect patterns. Chrome DevTools doe
