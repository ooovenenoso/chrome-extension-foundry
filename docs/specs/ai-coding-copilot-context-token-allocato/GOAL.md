# GOAL.md — AI Coding Copilot Context Token Allocator
...
Side panel shows which files and context chunks currently consume tokens in the active AI session, ranks them by contribution score. Cursor and Copilot now expose context telemetry. Strong wedge into 
