# GOAL.md — Postgres Explain Visualizer
...
Renders PostgreSQL query plans as interactive tree diagrams directly in the browser. Parses standard EXPLAIN format. Database devs desperately need better tooling.
